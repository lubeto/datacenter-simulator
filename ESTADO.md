...
- [ ] Verificar en producción que los tres bugs quedan resueltos después del deploy
- [ ] Revisar si `loadEvalReports()` (Reportes Evaluativos) carga correctamente los nombres en la tabla
